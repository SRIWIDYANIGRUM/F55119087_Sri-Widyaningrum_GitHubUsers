package com.f55119087.sriwidyaningrum_githubusers;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (getSupportActionBar() != null) {
            getSupportActionBar().setTitle("F55119087_List of Users");
        }
    ...
    private void getListUsers() {
        ...
        client.addHeader("Authorization", "token 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");
